...
//        buttonBackground = buttonLayers.findDrawableByLayerId(R.id.buttonBackground);
        ...
        int strokeColor;
        float slideTextSize = getResources().getDimensionPixelSize(R.dimen.sp16);
        String slideText;
...
//        setDrawableColor(buttonBackground, color.getDefaultColor());
    ...
    public void setOnActionDownListener(OnActionDownListener listener) {
        slider.setOnActionDownListener(listener, this);
    ...
    public void setOnActionUpListener(OnActionUpListener listener) {
        ...
        slider.setOnActionUpListener(listener, this);
    }
    ...
    public interface OnActionDownListener {
        void OnActionDown(SlideView slideView);
    }

    public interface OnActionUpListener {
        void OnActionUp(SlideView slideView);
    }
