...
public class AppointmentAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        appointmentTime.setText(CommonMethods.formatDateTime(_listDataHeader.get(groupPosition).getPatientList().get(0).getAppointmentTime(), RescribeConstants.DATE_PATTERN.hh_mm_a, RescribeConstants.DATE_PATTERN.HH_mm_ss, RescribeConstants.TIME).toLowerCase());
