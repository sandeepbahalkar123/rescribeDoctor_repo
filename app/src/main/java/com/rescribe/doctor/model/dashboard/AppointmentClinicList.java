...
public class AppointmentClinicList implements Parcelable {
    ...
    @SerializedName("appointmentOtherCount")
    @Expose
    private Integer appointmentOtherCount;
    ...
    protected AppointmentClinicList(Parcel in) {
        ...
        this.appointmentOtherCount = ((Integer) in.readValue((Integer.class.getClassLoader())));
    }
    ...
    public Integer getAppointmentOtherCount() {
        return appointmentOtherCount;
    }

    public void setAppointmentOtherCount(Integer appointmentOtherCount) {
        this.appointmentOtherCount = appointmentOtherCount;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(appointmentOtherCount);
    }
