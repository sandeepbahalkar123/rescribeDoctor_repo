...
public class RescribeConstants {
    ...
    public static final String TASK_DOCTOR_CONNECT_CHAT = "6";
    public static final String TASK_DOCTOR_CONNECT = "7";
    public static final String TASK_DOCTOR_FILTER_DOCTOR_SPECIALITY_LIST = "8";
    public static final String TASK_GET_PATIENT_LIST = "9";
    public static final String SEND_MESSAGE = "10";
    public static final String CHAT_HISTORY = "11";
    public static final String CHAT_USERS = "12";
    public static final String GET_PATIENT_CHAT_LIST = "13";

    public static final String ACTIVE_STATUS = "14";
    public static final String LOGOUT = "15";
    public static final String TASK_GET_APPOINTMENT_DATA = "16";
    public static final String TASK_GET_PATIENT_DATA = "17";
    public static final String TASK_ONE_DAY_VISIT = "18";
    public static final String MY_RECORDS_DOCTOR_LIST = "19";
    public static final String MY_RECORDS_ADD_DOCTOR = "20";
    public static final String TASK_PATIENT_HISTORY = "21";
    public static final String TASK_GET_DOCTOR_SMS_TEMPLATE = "22";
    public static final String TASK_REQUEST_SEND_SMS = "23";
    public static final String TASK_GET_WAITING_LIST = "24";
    public static final String TASK_GET_SEARCH_RESULT_MY_PATIENT = "25";
    public static final String TASK_ADD_TO_WAITING_LIST = "26";
    public static final String TASK_GET_LOCATION_LIST = "27";
    public static final String TASK_GET_DASHBOARD_RESPONSE = "28";
    public static final String TASK_DELETE_WAITING_LIST = "29";
    public static final String TASK_APPOINTMENT_CANCEL_OR_COMPLETE = "30";
    public static final String TASK_DARG_DROP = "31";
    public static final String TASK_GET_COMPLETED_OPD = "32";
    public static final String TASK_GET_NEW_PATIENT_LIST = "33";
    public static final String TASK_GET_DOCTOR_PATIENT_CITY = "34";
    public static final String TASK_ADD_NEW_PATIENT = "35";
    public static final String TASK_DELETE_PATIENT_OPD_ATTCHMENTS = "36";
    public static final String TASK_GET_TIME_SLOTS_TO_BOOK_APPOINTMENT = "37";
    public static final String TASK_CONFIRM_APPOINTMENT = "38";
    public static final String TASK_INCONSULATION_OR_COMPLETED_WAITING_LIST = "39";
    public static final String TASK_GET_STATE_AND_CITY_TO_ADD_NEW_PATIENT = "40";
    ...
    public static final String PATIENT_IS_DEAD = "is_dead";
