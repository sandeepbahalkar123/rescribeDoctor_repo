...
public class PatientAddDetailsListViewDialogFragment extends DialogFragment implements IdAndValueDataAdapter.OnItemClicked, HelperResponse {
    ...
    public static PatientAddDetailsListViewDialogFragment newInstance(Bundle bundle, OnItemClickedListener onItemClickedListener) {
        PatientAddDetailsListViewDialogFragment myAppointmentsFragment = new PatientAddDetailsListViewDialogFragment();
