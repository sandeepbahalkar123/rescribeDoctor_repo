...
public class StateCityAndAreaDialogFragment extends DialogFragment implements IdAndValueDataAdapter.OnItemClicked, HelperResponse {
    ...
    public static StateCityAndAreaDialogFragment newInstance(Bundle bundle, OnItemClickedListener onItemClickedListener) {
        StateCityAndAreaDialogFragment myAppointmentsFragment = new StateCityAndAreaDialogFragment();
