...
public class CityListViewDialogFragment extends DialogFragment implements IdAndValueDataAdapter.OnItemClicked, HelperResponse {
    ...
    public static CityListViewDialogFragment newInstance(Bundle bundle, CityAndAreaDialogFragment.OnItemClickedListener onItemClickedListener) {
        CityListViewDialogFragment myAppointmentsFragment = new CityListViewDialogFragment();
    ...
    private void fetchData() {
        ...
        if (internetAvailableCheck) {
            int[] i = new int[1];
            i[0] = mStateID;
            mAddNewPatientHelper.searchCity(i);
        } else {
            ...
            if (dbHelper.dataTableNumberOfRows(CitySyncJob.TAG) > 0) {
                ...
                if (mHeader.equalsIgnoreCase(getString(R.string.city))) {
    ...
    public void onSuccess(String mOldDataTag, CustomResponse customResponse) {
        ...
        StateAndCityBaseModel stateAndCityBaseModel = (StateAndCityBaseModel) customResponse;
        if (stateAndCityBaseModel != null) {
            ArrayList<StateDetailsModel> stateDetailsMainList = stateAndCityBaseModel.getCityDetailsDataModel().getStateDetailsMainList();
